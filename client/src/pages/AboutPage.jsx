...
function EditButton({ onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex items-center gap-1.5 rounded-none border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 shadow-sm hover:border-brand-300 hover:text-brand-700 transition-colors"
    ...
    <div className="mt-4 border border-brand-200 bg-slate-50 px-6 py-6 sm:px-8 sm:py-7 shadow-sm">
      <div className="flex items-start justify-between gap-4 mb-5">
        ...
        <button
          type="button"
          onClick={onClose}
          className="inline-flex items-center gap-1 rounded-none border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-600 hover:bg-slate-100"
        >
          <X className="h-4 w-4" />
          Fermer
        </button>
      ...
      <div className="mt-5 flex items-center gap-3">
        ...
        <button
          type="button"
          onClick={onClose}
          className="inline-flex items-center gap-2 rounded-none border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-100"
        >
          Annuler
        </button>
      </div>
          ...
          <div className="mt-6 border border-brand-200 bg-slate-800 px-6 py-6 sm:px-8 sm:py-7">
            <div className="flex items-start justify-between gap-4 mb-5">
              ...
              <button
                type="button"
                onClick={closeEdit}
                className="inline-flex items-center gap-1 rounded-none border border-slate-600 bg-slate-700 px-3 py-1.5 text-sm font-semibold text-slate-200 hover:bg-slate-600"
              >
                <X className="h-4 w-4" />
                Fermer
              </button>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={closeEdit}
                className="inline-flex items-center gap-2 rounded-none border border-slate-600 bg-slate-700 px-5 py-2.5 text-sm font-semibold text-slate-300 hover:bg-slate-600"
              >
                Annuler
              </button>
            </div>
