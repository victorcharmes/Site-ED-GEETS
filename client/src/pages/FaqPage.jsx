...
import { ChevronDown, Plus, Edit2, Trash2, X, FolderPlus, Pencil, Check } from 'lucide-react'
...
export default function FaqPage() {
  ...
  const faqHeader = useEditableText('faq_page_header', "Retrouvez les réponses aux questions les plus fréquentes concernant le déroulement de votre thèse à l'ED GEETS.")
            ...
            <div>
              ...
              {faqHeader.editing ? (
                <div className="mt-1">
                  ...
                  <textarea value={faqHeader.editValue} onChange={e => faqHeader.setEditValue(e.target.value)} rows={2}
                  ...
                  <div className="flex gap-3 mt-2">
                    <button onClick={faqHeader.save} disabled={faqHeader.saving}
                      ...
                      <Check className="h-3.5 w-3.5" />{faqHeader.saving ? 'Enregistrement...' : 'Enregistrer'}
                    </button>
                    <button onClick={faqHeader.cancelEdit}
                ...
                <div className="flex items-start gap-3">
                  <p className="text-xl text-univ-100 leading-relaxed max-w-2xl">{faqHeader.text}</p>
                  {isAdmin && (
                    <button onClick={faqHeader.startEdit}
