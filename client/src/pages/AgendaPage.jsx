...
import { Calendar, Plus, Edit2, Trash2, X, MapPin, Clock, Pencil, Check } from 'lucide-react'
...
export default function AgendaPage() {
  ...
  const agendaHeader = useEditableText('agenda_page_header', "Découvrez les événements à venir, les soutenances et les dates importantes de l'ED GEETS.")
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              {agendaHeader.editing ? (
                <div className="mt-1">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-univ-200 mb-2">Édition admin</p>
                  <textarea value={agendaHeader.editValue} onChange={e => agendaHeader.setEditValue(e.target.value)} rows={2}
                  ...
                  <div className="flex gap-3 mt-2">
                    <button onClick={agendaHeader.save} disabled={agendaHeader.saving}
                      ...
                      <Check className="h-3.5 w-3.5" />{agendaHeader.saving ? 'Enregistrement...' : 'Enregistrer'}
                    </button>
                    <button onClick={agendaHeader.cancelEdit}
                ...
                <div className="flex items-start gap-3">
                  <p className="text-xl text-univ-100 leading-relaxed max-w-2xl">{agendaHeader.text}</p>
                  {isAdmin && (
                    <button onClick={agendaHeader.startEdit}
