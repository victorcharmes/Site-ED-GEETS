              ...
              <div key={stat.id} className="flex flex-col items-stretch relative">
                {isAdmin && (
                  <button
                    ...
                    className="absolute right-3 top-3 z-10 inline-flex items-center gap-1 rounded-none border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-600 shadow-sm hover:border-brand-300 hover:text-brand-700"
